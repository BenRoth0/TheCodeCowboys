...
namespace PromptQuest.Services {
	...
	public class MapService : IMapService {
		...
		private static readonly List<MapNode> _mapNodesFloor1 = new List<MapNode>
		{
		...
		private static readonly List<MapNode> _mapNodesFloor2 = new List<MapNode>
		{
		...
		private static readonly List<MapNode> _mapNodesFloor3 = new List<MapNode>
		{
			new MapNode { MapNodeId = 1, NodeType = "Enemy", ConnectedNodes = {2, 3}, NodeHeight = 2, NodeDistance = 1 },
		...
		private static readonly List<MapNode> _mapNodesFloor4 = new List<MapNode>
		{
			new MapNode { MapNodeId = 1, NodeType = "Enemy", ConnectedNodes = {2, 3}, NodeHeight = 2, NodeDistance = 1 },
		...
		private static readonly List<MapNode> _mapNodesFloor5 = new List<MapNode>
		{
			new MapNode { MapNodeId = 1, NodeType = "Enemy", ConnectedNodes = {2, 3}, NodeHeight = 2, NodeDistance = 1 },
		...
		private static readonly List<MapNode> _mapNodesFloor6 = new List<MapNode>
		{
		...
		private static readonly List<MapNode> _mapNodesFloor7 = new List<MapNode>
		{
		...
		// Helper to get the correct map nodes for the current floor
		private List<MapNode> GetMapNodesForFloor(int floor) {
			switch(floor) {
				case 1:
					return _mapNodesFloor1;
				case 2:
					return _mapNodesFloor2;
				case 3:
					return _mapNodesFloor3;
				case 4:
					return _mapNodesFloor4;
				case 5:
					return _mapNodesFloor5;
				case 6:
					return _mapNodesFloor6;
				case 7:
					return _mapNodesFloor7;
				default:
					// Randomly select one of the 7 maps if floor is out of range
